...
import { ISaveJob, ISavingManagerListener, Saver, SavingStatus } from '.';
  ...
  implements Partial<IApplicationListener>, Partial<IRouterListener>
{
  ...
  private _status: SavingStatus = 'saved';
  ...
  protected onSaveState(savingState: SavingStatus) {
