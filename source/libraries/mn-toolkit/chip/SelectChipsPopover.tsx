...
> {
  public static get defaultProps(): Partial<ISelectChipsPopoverProps<number>> {
    return {
      ...super.defaultProps,
    };
  }
  ...
  protected override async onTapAction(event: React.MouseEvent, action: IActionsPopoverAction<ID>) {
