...
export class Masonry extends Container<IMasonryProps, IMasonryState> {
  ...
  public static get defaultProps(): Partial<IMasonryProps> {
    return {
      ...super.defaultProps,
      layout: 'horizontal',
      wrap: true,
  ...
  private computeLayout = () => {
    ...
    const space = childSize.space ?? app.$theme.settings['theme-default-spacing']?.value ?? 0;
  ...
  public override get children() {
    ...
    if (isDefined(this.props.childSize?.space)) {
      ...
      space = app.$theme.getUnitString(app.$theme.settings['theme-default-spacing']);
    }
