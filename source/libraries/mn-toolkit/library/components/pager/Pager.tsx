...
interface IPagerProps extends IContainerProps {
  position?: number;
  total?: number;
  pageSize?: number;
...
interface IPagerState extends IContainerState {
  total: number;
  position: number;
  pageSize: number;
}

export class Pager extends Container<IPagerProps, IPagerState> {
  public static override get defaultProps(): IPagerProps {
    return {
      ...super.defaultProps,
      layout: 'horizontal',
      gutter: true,
  ...
  public override get children() {
    return [
      ...
      <Typography key='count' content={`Page ${this.state.position + 1} sur ${this.nbPages}`} />,
