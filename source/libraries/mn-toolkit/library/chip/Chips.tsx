...
export interface IChipItem<ID = number> {
  ...
  onTapOverride?: (event?: React.MouseEvent) => void | Promise<void>;
  icon?: TIconId;
  actionIcon?: TIconId;
...
export class Chips<ID = number> extends Container<IChipsProps<ID>, IChipsState<ID>> {
  public static get defaultProps(): Partial<IChipsProps> {
    return {
      ...super.defaultProps,
      layout: 'horizontal',
      gutter: true,
