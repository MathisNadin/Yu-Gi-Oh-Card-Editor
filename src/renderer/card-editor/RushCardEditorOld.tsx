...
interface IRushCardEditorOldProps extends IContainableProps {
  card: ICard;
  onCardChange: (card: ICard) => void;
}

interface IRushCardEditorOldState extends IContainableState {
  import: string;
  card: ICard;
  cardFrames: {
    id: TFrame;
...
export class RushCardEditorOld extends Containable<IRushCardEditorOldProps, IRushCardEditorOldState> {
  private debouncedOnCardChange: (card: ICard) => void;

  public constructor(props: IRushCardEditorOldProps) {
    super(props);
  ...
  public componentWillReceiveProps(nextProps: IRushCardEditorOldProps, _prevState: IRushCardEditorOldState) {
