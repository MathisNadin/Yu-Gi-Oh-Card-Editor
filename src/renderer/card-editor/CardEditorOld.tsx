...
interface ICardEditorOldProps extends IContainableProps {
  card: ICard;
  onCardChange: (card: ICard) => void;
}

interface ICardEditorOldState extends IContainableState {
  import: string;
  lockPend: boolean;
  card: ICard;
  cardFrames: {
...
export class CardEditorOld extends Containable<ICardEditorOldProps, ICardEditorOldState> {
  private debouncedOnCardChange: (card: ICard) => void;

  public constructor(props: ICardEditorOldProps) {
    super(props);
  ...
  public componentWillReceiveProps(nextProps: ICardEditorOldProps, _prevState: ICardEditorOldState) {
